...
function About() {
  return (
    <View className='about flex-column'>
      ...
      <Text className='pd-20'>本小程序使用开放api（来源于github：RollToolsApi），仅供交流学习，如有恶意使用者，承担一切后果；如有侵权请联系删除。</Text>
      ...
      <Text className='pd-20'>2.养眼福利图保存图片需要使用手机相册权限，请确保小程序有使用权限。</Text>
      <Text className='pd-20'>3.万能方法：升级小程序后导致权限获取失败，请在微信-发现-小程序里面删除小程序后再添加小程序。</Text>
    </View>
  )
}
