    ...
    <View className='font26 h100-per white index'>
      ...
      <View className='flex-row flex-wrap pd-40 bd-box' style={{backgroundColor: '#1E154D'}}>
        ...
        <View className='flex-50per bd-box'>
          <Navigator className='flex-column bg-purple-A700 bd-radius pd-20 pd-b-30 mg-20 relative' url={`/pages/jokes/jokes?color=${colors.jokes}`}>
            <View className='flex-row space-between'>
        ...
        <View className='flex-50per bd-box'>
          <Navigator className='flex-column bg-teal-A700 bd-radius pd-20 pd-b-30 mg-20 relative' url={`/pages/calculator/calculator?color=${colors.calculator}`}>
            <View className='flex-row space-between'>
        ...
        <View className='flex-50per bd-box'>
          <Navigator className='flex-column bg-orange bd-radius pd-20 pd-b-30 mg-20 relative' url={`/pages/phone_location/phone_location?color=${colors.phone_location}`}>
            <View className='flex-row space-between'>
              <View className='lh-64'><Text className='font40'>手</Text>机号归属地</View>
              <View className='iconfont w64 h64 lh-64 text-center font40'>&#xe784;</View>
            </View>
            <View className='font24'>查询手机归属地</View>
            <View className='btm-shadow bg-orange' />
            <Image className='item-line-img h100-per w100-per' src={itemImgPath} />
          </Navigator>
        </View>
        <View className='flex-50per bd-box'>
          <Navigator className='flex-column bg-brown-800 bd-radius pd-20 pd-b-30 mg-20 relative' url={`/pages/ip_search/ip_search?color=${colors.ip_search}`}>
            <View className='flex-row space-between'>
        ...
        <View className='flex-50per bd-box'>
          <Navigator className='flex-column bg-lime-A700 bd-radius pd-20 pd-b-30 mg-20 relative' url={`/pages/calendar/calendar?color=${colors.calendar}`}>
            <View className='flex-row space-between'>
              <View className='lh-64'><Text className='font40'>万</Text>年历</View>
              <View className='iconfont w64 h64 lh-64 text-center font46'>&#xe878;</View>
            </View>
            <View className='font24'>日期/节日/星座/宜忌</View>
            <View className='btm-shadow bg-lime-A700' />
            <Image className='item-line-img h100-per w100-per' src={itemImgPath} />
          </Navigator>
        </View>
        <View className='flex-50per bd-box'>
          <Navigator className='flex-column bg-green-A700 bd-radius pd-20 pd-b-30 mg-20 relative' url={`/pages/trash_sort/trash_sort?color=${colors.trash_sort}`}>
            <View className='flex-row space-between'>
        ...
        <View className='flex-50per bd-box'>
          <Navigator className='flex-column bg-deep-purple-A700 bd-radius pd-20 pd-b-30 mg-20 relative' url={`/pages/express_note/express_note?color=${colors.express_note}`}>
            <View className='flex-row space-between'>
        ...
        {productConfig.news && <View className='flex-50per bd-box'>
          <Navigator className='flex-column bg-red-A200 bd-radius pd-20 pd-b-30 mg-20 relative' url={`/pages/news/news?color=${colors.news}`}>
            <View className='flex-row space-between'>
        ...
        {productConfig.girls && <View className='flex-50per bd-box'>
          <Navigator className='flex-column bg-yellow bd-radius pd-20 pd-b-30 mg-20 relative' url={`/pages/girls/girls?color=${colors.girls}`}>
            <View className='flex-row space-between'>
